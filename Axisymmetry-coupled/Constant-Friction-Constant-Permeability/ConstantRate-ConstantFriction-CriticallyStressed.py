...
# Coupled simulation with constant rate injection and constant friction.
...
elastic_m = Elasticity(kernel, elas_properties, max_leaf_size=20, eta=4.0, eps_aca=1.0e-3,n_openMP_threads=8)
...
Simul_description = (
    "Axi Symm - ct rate - ct friction - coupled simulation - crit stress"
)
now = datetime.now()
