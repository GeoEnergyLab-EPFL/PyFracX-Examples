...
This example demonstrates the capability of the PyFracX code to reproduce the nucleation and arrest of an instability associated with fluid-injection into a planar fault with linear weakening friction.
