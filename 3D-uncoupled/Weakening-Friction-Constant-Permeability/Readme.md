...
![Evolution of rupture radius in a linear slip-weakening fault P 0.05](figures_ref/linear_weakening_verification.png)

S = 0.6, F = 0.7, P = 0.035, linear weakening
![Evolution of rupture radius in a linear slip-weakening fault P 0.035](figures_ref/linear_weakening_nucleation.png)
