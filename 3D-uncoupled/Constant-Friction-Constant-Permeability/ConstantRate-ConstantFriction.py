...
from pyfracx.hm.HMFsolver import HMFSolution, hmf_coupled_step, hmf_one_way_step
...
pressure = lambda r, t: (
    p0 - Qinj / (4 * hyd_cond * np.pi * wh_o) * expi(-(r**2) / (4.0 * alpha_h * t))
)
