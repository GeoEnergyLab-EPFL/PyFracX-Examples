...
plt.savefig(
    os.path.join(figure_dir, "shear_traction_profile.png"), dpi=200, bbox_inches="tight"
)
# plt.show()
...
plt.savefig(
    os.path.join(figure_dir, "yield_function_profile.png"), dpi=200, bbox_inches="tight"
)
# plt.show()
